...
async function seed() {
  ...
  // ──────────────────────────────────────────
  const now = new Date();
  const content1 = `<p>2025, fazlalıktan arınmış bir modanın yılı olarak öne çıkıyor. Sosyal medyanın "daha az, daha iyi" söylemi artık sadece bir trend değil, bilinçli tüketicilerin kalıcı tercihi haline geldi.</p><h2>Nötr Renk Paleti</h2><p>Siyah, beyaz, krem, taş ve gri tonları 2025'in vazgeçilmezi. Bu renkler birbirleriyle mükemmel uyum sağlayarak mix-and-match kolaylaşıyor.</p><h2>Ağır Kumaş, Uzun Ömür</h2><p>380 gsm ve üzeri ağır pamuk kullanımı hem görsel hem dokunsal bir kalite hissi yaratıyor. Ürünler yıkanma ve yıpranmaya karşı daha dayanıklı oluyor.</p><h2>Oversized Silüet Devam Ediyor</h2><p>Boxy ve dropped shoulder kesimler rahat görünümlü ama bilinçli bir estetik sunuyor. Doğru orantılarla giyildiğinde son derece şık bir etki yaratıyor.</p>`;
  const content2 = `<p>Capsule wardrobe fikri, 1970'lerde ortaya çıktı ve bugün minimalist yaşam anlayışının en güçlü sembollerinden biri haline geldi.</p><h2>Temel 10 Parça</h2><ol><li>Beyaz essential tee x2</li><li>Siyah oversized hoodie</li><li>Slim fit siyah pantolon</li><li>Açık gri crewneck sweatshirt</li><li>Krem varsity ceket</li><li>Siyah şort</li><li>Beyaz sneaker</li><li>Siyah logo cap</li></ol><h2>Neden İşe Yarıyor?</h2><p>Bu 10 parçayla matematiksel olarak 47 farklı kombinasyon kurabilirsiniz.</p>`;
  const content3 = `<p>Kumaş gsm (gram per square meter) değeri, bir kumaşın ne kadar ağır ve kalın olduğunu belirtir.</p><h2>GSM Değerleri</h2><ul><li><strong>140-180 gsm</strong>: Ucuz market tişörtleri.</li><li><strong>220-280 gsm</strong>: Standart kaliteli tişört.</li><li><strong>320-380 gsm</strong>: Premium tişört. Ağır, dolu tutum.</li><li><strong>420-550 gsm</strong>: Hoodie kalitesi.</li></ul><h2>Neden VAULT 380 gsm Kullanıyor?</h2><p>380 gsm'nin altı bize kaliteli hissi vermiyor. Müşterilerimiz ürünü eline aldığında hissettiği ağırlık, satın alma kararının %40'ını etkiliyor.</p>`;

  const blogPosts = [
    {
      title: { tr: '2025\'in Minimal Moda Trendleri: Az Parça, Daha Fazla Stil', en: null },
      slug: '2025-minimal-moda-trendleri',
      excerpt: { tr: 'Bu yıl dolap doldurmak yerine doğru parçaları seçmek öne çıkıyor. Capsule wardrobe, nötr renkler ve premium kumaşlarla nasıl minimal bir tarz oluşturursunuz?', en: null },
      content: { tr: content1, en: null },
      status: 'published',
      ...
      seo: {
        metaTitle: { tr: '2025 Minimal Moda Trendleri — VAULT Blog', en: null },
        metaDesc:  { tr: '2025\'in en güçlü minimal moda trendleri: capsule wardrobe, nötr renkler ve ağır kumaş seçimi hakkında her şey.', en: null },
      },
    },
    {
      title: { tr: 'Capsule Wardrobe: 10 Parçayla Eksiksiz Gardırop', en: null },
      slug: 'capsule-wardrobe-10-parca',
      excerpt: { tr: 'Her sabah "ne giyeceğim?" sorusunu bitirmenin zamanı geldi. 10 temel parçayla sonsuz kombinasyon yapabileceğiniz bir gardırop kurma rehberi.', en: null },
      content: { tr: content2, en: null },
      status: 'published',
      ...
      seo: {
        metaTitle: { tr: 'Capsule Wardrobe: 10 Parçayla Eksiksiz Gardırop — VAULT', en: null },
        metaDesc:  { tr: '10 temel kıyafetle sonsuz kombinasyon yapmanın yolu. Capsule wardrobe rehberi.', en: null },
      },
    },
    {
      title: { tr: 'Premium Kumaş Neden Önemli? 280 gsm vs 550 gsm', en: null },
      slug: 'premium-kumas-neden-onemli',
      excerpt: { tr: 'Bir tişörte 200 TL değil 890 TL ödemenin mantığı nedir? Kumaş ağırlığı, iplik kalitesi ve üretim süreci arasındaki farkları açıklıyoruz.', en: null },
      content: { tr: content3, en: null },
      status: 'published',
      ...
      seo: {
        metaTitle: { tr: 'Premium Kumaş Neden Önemli? — VAULT Blog', en: null },
        metaDesc:  { tr: 'GSM değerleri ve kumaş kalitesi arasındaki fark.', en: null },
      },
    },
  ];
  ...
  // ──────────────────────────────────────────
  const faqs = [
    { question: { tr: 'Kargo süresi ne kadar?', en: null }, answer: { tr: 'Siparişler 1-2 iş günü içinde kargoya verilir. İstanbul içi teslimat genellikle ertesi gün, Türkiye geneli 2-4 iş günüdür. Kargo ücretsizdir (750 TL ve üzeri alışverişlerde).', en: null }, order: 1 },
    { question: { tr: 'İade ve değişim yapabilir miyim?', en: null }, answer: { tr: '14 gün içinde, kullanılmamış ve etiketi üzerinde olan ürünleri iade edebilirsiniz. İade kargo ücretini biz karşılıyoruz.', en: null }, order: 2 },
    { question: { tr: 'Beden seçiminde ne önerirsiniz?', en: null }, answer: { tr: 'Oversized modeller için normal bedeninizi, slim/form modeller için ise bir beden büyük almanızı öneririz.', en: null }, order: 3 },
    { question: { tr: 'Kumaşlar nasıl yıkanmalı?', en: null }, answer: { tr: 'Tüm ürünlerimizi 30°C\'da ters çevirerek makine yıkamanızı öneririz. Çamaşır suyu ve yumuşatıcı kullanmayın.', en: null }, order: 4 },
    { question: { tr: 'Mağaza adresiniz nerede?', en: null }, answer: { tr: 'Nişantaşı, Teşvikiye Caddesi No:42, İstanbul. Pazartesi-Cumartesi 10:00-20:00, Pazar 12:00-18:00.', en: null }, order: 5 },
  ];
  ...
  await NavigationMenu.create({
    ...
    items: [
      ...
      { label: 'Koleksiyonlar',   url: '/koleksiyonlar',  order: 2 },
      { label: 'Hakkımızda',      url: '/hakkimizda',     order: 3 },
      { label: 'Blog',            url: '/blog',           order: 4 },
      { label: 'İletişim',        url: '/iletisim',       order: 5 },
    ],
  });
  ...
  await SeoSettings.create({
    tenantId: tid,
    siteName: { tr: 'VAULT', en: 'VAULT' },
    defaultMetaTitle: { tr: 'VAULT — Minimal Giyim, Maksimal Etki', en: 'VAULT — Minimal Clothing, Maximal Impact' },
    defaultMetaDescription: { tr: 'Premium kumaşlar ve zamansız kesimlerle modern giyim. VAULT koleksiyonlarını keşfedin.', en: 'Modern fashion with premium fabrics and timeless cuts. Explore VAULT collections.' },
